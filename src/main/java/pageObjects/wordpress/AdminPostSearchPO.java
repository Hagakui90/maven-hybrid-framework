...
public class AdminPostSearchPO extends BasePage {
	...
	public void enterToSearchPostsButton() {
	...
	public boolean isPostSearchTableDisplayed(String headerID, String cellValue) {
		int headerIndex = getElementSize(driver, AdminPostSearchPageUI.TABLE_HEADER_INDEX_BY_TABLE_NAME, headerID) + 1;
	...
	public void selectTextItemInActionDropdown(String dropdownItem) {
		...
		selectItemInDefautlDropdown(driver, AdminPostSearchPageUI.ACTION_DROPDOWN, dropdownItem);
	}
	...
	public boolean isMoveToBinMessageDisplayed(String message) {
		waitForElementVisible(driver, AdminPostSearchPageUI.MOVE_TO_BIN_MESSSAGE, message);
		return isElementDisplayed(driver, AdminPostSearchPageUI.MOVE_TO_BIN_MESSSAGE, message);
	}
